...
// https://etherscan.io/tx/0xcadc826bb07c532cbef62f0d0c9723356c4f48ea46c3d0869ca15399607a9f42
// https://kovan.etherscan.io/tx/0x125a00bd2ebba38c05c37aaf779315cd31346d0699622224d8cc46e4b3f94545
function register() {
    let data = SHA256( $('#dataToRegister').val() )
    // let data = $('#dataToRegister').val()
...
function setHashValue(data) {
    document.getElementById('dataHash').innerHTML = SHA256(data)
}
